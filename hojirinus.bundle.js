...
(function () {
  ...
  __def('state', function () {
    ...
    return { addCoins, buy, canBuy, consume, costOf, digNeed, distanceOf, effBonus, gain, godSetDone, hasSeen, launchV, load, milestone, pickPower, playerPower, powerRatio, roll, S, save, seenGods, seenNormal, seenSecrets, session, simDist, speedMul, stockOf, totalStock, updateRecord, upLevel, upRate, wipe };
  });
